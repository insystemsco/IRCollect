...
:: set storage locations prefers tanium folder but will fall back to root of C:\
if not exist C:\Tanium\Client goto taniumdir else set cdrive="C:\Tanium\Tanium Client\IR\%computername%\"
:taniumdir
if not exist "C:\Program Files(x86)\Tanium\Tanium Client\" goto taniumdir2 else set cdrive="C:\Program Files(x86)\Tanium\Tanium Client\IR\%computername%\" 
taniumdir2
if not exist "C:\Program Files\Tanium\Tanium Client\" goto default else set cdrive="C:\Program Files(x86)\Tanium\Tanium Client\IR\%computername%\" 
:default
if not defined cdrive (set cdrive=c:\%computername%\)
...
set tanium=172.16.64.40\c$\gatherer
...
xcopy %cdrive%\%computername%.zip \\%tanium% /E /I /C /Y /Z
